...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Ajout d'un QHBoxLayout pour le bouton de recherche
       ...
       # Ajout du bouton de recherche
        ...
        self.button_progress_layout.addLayout(self.button_layout)
    ...
    def update_visualization(self, keyword):
        ...
        data = None  # Initialisez la variable data à None

        if country_count or site_count or date_count:
    ...
    def update_statistics(self):
        ...
        # Analysez les résultats de la recherche pour extraire les informations nécessaires
        articles = self.analyze_search_results(search_results)
    ...
    def prepare_data_for_plot(articles):
        # Préparez les données pour le tracé du graphique
        data = {}
